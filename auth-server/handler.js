...
const credentials = {
  ...
  redirect_uris: ["https://ThomasSSwanson.github.io/meet/"],
  javascript_origins: ["https://ThomasSSwanson.github.io", "http://localhost:3000"],
};
...
module.exports.getAccessToken = async (event) => {
  ...
  module.exports.getCalenarEvents = async (event) => {
